...
//----------------------------------------------------------
void VertexDeclaration::AppendAttribute(volpe::Attribute p_attr, int p_iNumComponents, volpe::ComponentType p_type, int p_iOffset)
{
	AttributeInfo info;
	info.m_attr				= p_attr;
	info.m_type				= p_type;
...
//----------------------------------------------------------
void VertexDeclaration::SetVertexBuffer(volpe::VertexBuffer* p_pVB)
{
	m_pVB = p_pVB;
}
...
//----------------------------------------------------------
void VertexDeclaration::SetIndexBuffer(volpe::IndexBuffer* p_pIB)
{
	m_pIB = p_pIB;
}
