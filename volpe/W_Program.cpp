...
static const char* gs_aAttributeMap[volpe::AT_NUM_ATTRIBS] =
{
...
{
    GLchar* pFileContents = (GLchar *)volpe::LoadWholeFile(vsFile);
    ...
    pFileContents = (GLchar *)volpe::LoadWholeFile(fsFile);
...
//----------------------------------------------------------
void Program::SetUniform(const std::string& name, const volpe::Color4& color)
{
...
void Program::_compile(std::size_t variantKey, const std::set<std::string>& keywords)
{
	...
	for( int i = 0; i < volpe::AT_NUM_ATTRIBS; i++ )
	{
